          ...
          <section className="detail-section">
            <div className="container">
              ...
              <div className="detail-action">
                ...
                <Link to="/it-services/offers" className="btn btn-primary" style={{ marginRight: '12px' }}>View Startup Offers</Link>
        ...
        <section className="detail-section">
          <div className="container">
            ...
            <div className="detail-action" style={{ marginTop: '48px' }}>
              <Link to="/it-services/offers" className="btn btn-secondary">Offers</Link>
